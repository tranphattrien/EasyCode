              ...
              <div className="flex max-sm:flex-col justify-between my-8">
                <div className="flex gap-5 items-start">
                  ...
                  <p className="capitalize">
                    {fullname}
                    <br />
                    <Link to={`/user/${author_username}`} className="">
                      @{author_username}
                    </Link>
                  </p>
                </div>

                <p className="text-dark-grey opacity-80 max-sm:mt-6 max-sm:ml-12 max-sm:pl-5">
...
export function useBlogContext() {
  ...
  if (context === null) {
    throw new Error("useBlogContext must used within a BlogContextProvider");
  }
  return context;
}
